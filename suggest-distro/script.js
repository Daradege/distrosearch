...
document.addEventListener("DOMContentLoaded", function () {
    fetch("https://cdn.jsdelivr.net/gh/Daradege/distrosearch@refs/heads/main/database.json")
    .then(data => data.json())
    .then(data => {
        databaseData = data;
    ...
    document.getElementById("submitbutton").addEventListener("click", function() {
        ...
        for (const base in databaseData.bases) {
            for (const distroName in databaseData.bases[base]) {
                const distro = databaseData.bases[base][distroName];
